...
CLASS lhc_Travel IMPLEMENTATION.
 ...
 DATA legacy_entity_in   TYPE /dmo/travel.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zsrap_travel_x_rt007( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_zi_rap_travel_u_rt007 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_zi_rap_travel_u_rt007 IMPLEMENTATION.
