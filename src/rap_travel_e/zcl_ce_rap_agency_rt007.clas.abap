CLASS zcl_ce_rap_agency_rt007 DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zrap_rt007z_travel_agency_es5-agencyid.
    TYPES t_business_data TYPE TABLE OF zrap_rt007z_travel_agency_es5.
...
CLASS zcl_ce_rap_agency_rt007 IMPLEMENTATION.
...
*/In a non-Trial SAP Cloud Platform, ABAP Environment system one would leverage the destination service of the
*/underlying Cloud Foundry Environment and one would use the statement
*/cl_http_destination_provider=>create_by_cloud_destination to generate a http destination in the ABAP
*/Environment system based on these settings.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_RT007' ).
